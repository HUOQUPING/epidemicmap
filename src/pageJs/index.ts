...
const initDataFun = async (data: InteData) => {
    ...
    let lineDom: HTMLElement | null = document.getElementById("line");
    let lineDom1: HTMLElement | null = document.getElementById("line1");
    let lineDom2: HTMLElement | null = document.getElementById("line2");
    ...
    let myLine = echarts.init(lineDom as HTMLElement);
    let myLin1 = echarts.init(lineDom1 as HTMLElement);
    let myLin2 = echarts.init(lineDom2 as HTMLElement);
    ...
    data.gdData = data.china.find((v) => v.id === "440000");
