    ...
    <div class="top-box">
      ...
      <div v-if="chinaTotal.total" class="cover-cards">
        ...
        <div v-show="data.type === 2" class="cover-info">
          <div>
            <p class="title">累计确诊</p>
            <p class="number">{{ gdData.total.confirm }}</p>
            <p class="tip">
              较昨日
          ...
          <div>
            <p class="title">累计死亡</p>
            <p class="number">{{ gdData.total.dead }}</p>
            <p class="tip">
              较昨日
          ...
          <div>
            <p class="title">累计治愈</p>
            <p class="number">{{ gdData.total.heal }}</p>
            <p class="tip">
              较昨日
...
const { chinaTotal, gdData, china, areaTree } = toRefs(data);
...
// const lineTypeChange=(type:number)=>{
//   data.lineType=type
// }
